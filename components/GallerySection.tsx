  ...
  return (
    <section className="py-[60px] px-0 bg-[#1C4422] fade-in">
      <div className="px-6 pb-8">
        ...
        <h2 className="font-serif text-[clamp(1.6rem,5vw,2.2rem)] font-bold leading-[1.2] text-white">Ve lo que estás comprando</h2>
      </div>

      <div className="flex gap-4 overflow-x-auto scroll-smooth px-6 pb-4 scrollbar-hide" style={{ scrollSnapType: 'x mandatory' }}>
        {slides.map((slide, index) => (
          <div
            key={index}
            className="flex-0-0-[78vw] max-w-[340px] scroll-snap-center rounded-2xl overflow-hidden bg-[rgba(255,255,255,0.1)] backdrop-blur-sm border border-[rgba(255,255,255,0.15)]"
          ...
          >
            ...
            <div className="p-3.5 px-4">
              ...
              <p className="text-xs text-[rgba(255,255,255,0.6)]">{slide.desc}</p>
            </div>
          </div>
        ))}
      </div>

      <div className="text-center mt-4 px-6 text-[rgba(255,255,255,0.4)] text-xs flex items-center justify-center gap-2">
